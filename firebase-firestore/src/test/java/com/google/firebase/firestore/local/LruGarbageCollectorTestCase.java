...
public abstract class LruGarbageCollectorTestCase {
  ...
  public void testGCRan() {
    ...
    LruGarbageCollector.Params defaultParams = LruGarbageCollector.Params.Default();
    // Set a low byte threshold so we can guarantee that GC will run.
    LruGarbageCollector.Params params =
        new LruGarbageCollector.Params(
            100, defaultParams.percentileToCollect, defaultParams.maximumSequenceNumbersToCollect);
